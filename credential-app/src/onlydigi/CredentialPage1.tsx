...
const CredentialPage1: React.FC<CredentialPageProps> = ({ setPage1 }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[950px] bg-purple-100 p-6">
        <div className="flex justify-between items-center mb-8">
          <button className="text-gray-700 relative -top-28 -left-48" onClick={() => setPage1("verifiable-credential")}>
      ...
      {/* <button className="mt-6 bg-purple-700 text-white px-6 py-2 rounded-md shadow-md hover:bg-purple-800" onClick={() => setPage1("redirect-page")}>
...
export default CredentialPage1;
